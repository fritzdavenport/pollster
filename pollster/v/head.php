...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href=<?php echo ((@$_SERVER["HTTPS"])?'https://':'http://').$_SERVER['SERVER_NAME'].reset(explode('/s',$_SERVER['PHP_SELF']))."/mainstyle.css"; ?> type="text/css" media="screen">
		<!--[if lt IE 9]> 
